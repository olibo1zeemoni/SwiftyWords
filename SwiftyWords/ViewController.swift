...
//  SwiftyWords
//
//  Created by Olibo moni on 10/02/2022.
//
...
class ViewController: UIViewController {
    ...
    override func loadView() {
        ...
        NSLayoutConstraint.activate([
            ...
            buttonView.widthAnchor.constraint(equalToConstant: 950),
            buttonView.heightAnchor.constraint(equalToConstant: 420),
    ...
    @objc func submitTapped(_ sender: UIButton){
        ...
        if let solutionPosition = solutions.firstIndex(of: answerText){
            ...
            if score % 7 == 0 {
                ...
                ac.addAction(UIAlertAction(title: "Let's go!", style: .default) { action in self.levelUp(action: action)}  )
